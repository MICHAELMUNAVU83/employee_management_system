defmodule EmployeeManagementSystem.Users.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, EmployeeManagementSystem.Repo)
  ...
  """
  def valid_password?(
        %EmployeeManagementSystem.Users.User{hashed_password: hashed_password},
        password
      )
